# Support for Output Descriptors in Projectxcl Core

Since Projectxcl Core v0.17, there is support for Output Descriptors. This is a
...
existing Projectxcl Core wallets, a convenience function `combo` is
