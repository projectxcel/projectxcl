...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " projectxcl-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  projectxcl-tx [options] <hex-tx> [commands]  Update hex-encoded projectxcl transaction\n" +
            "or:     projectxcl-tx [options] -create [commands]   Create hex-encoded projectxcl transaction\n" +
            "\n";
