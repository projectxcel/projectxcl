...
"""Verify that starting projectxcl with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start projectxcl with -h for help text")
        ...
        self.log.info("Start projectxcl with -version for version information")
        ...
        self.log.info("Start projectxcld with -fakearg to make sure it does not start")
