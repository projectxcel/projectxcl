Contributing to Projectxcl Core
============================

The Projectxcl Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Projectxcl Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/projectxcl-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to projectxcl-qt
...
The following applies to code changes to the Projectxcl Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Projectxcl
Network Protocol consensus changes.

Whether a pull request is merged into Projectxcl Core rests with the project merge
...
Patches that change Projectxcl consensus rules are considerably more involved than
...
Where a patch set proposes to change the Projectxcl consensus, it must have been
...
The project leader is the release manager for each Projectxcl Core release.
